        ...
        <>
            {links[0].href?.includes("/") &&
                links.map((link, index) => (
                    <li key={index} style={{ color: "#FECD8C" }}>
                        <Link
                        ...
                        >
                            {animateY ? (
                                <span class='btn-animate-y'>
                                    <span class='btn-animate-y-1' style={{ color: "#FECD8C" }}>
                                        {link.text}
                                    </span>
                                    <span class='btn-animate-y-2' style={{ color: "#FECD8C" }} aria-hidden='true'>
                                        {link.text}
                                    </span>
                                </span>
                            ) : (
            ...
            {!links[0].href?.includes("/") &&
                links.map((link, index) => (
                    <li className='scrollspy-link' key={index} style={{ color: "#FECD8C" }}>
                        <a onClick={() => closeMobileMenu()} className='' href={link.href} style={{ color: "#FECD8C" }}>
                            {animateY ? (
                                <span class='btn-animate-y'>
                                    <span class='btn-animate-y-1' style={{ color: "#FECD8C" }}>
                                        {link.text}
                                    </span>
                                    <span class='btn-animate-y-2' aria-hidden='true' style={{ color: "#FECD8C" }}>
                                        {link.text}
                                    </span>
                                </span>
                            ) : (
