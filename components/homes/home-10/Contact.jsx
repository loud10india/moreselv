        ...
        <div className='container'>
            <div className='row mb-90 mb-sm-50'>
                <div className='col-lg-5 col-xl-4 mb-md-90 mb-sm-50 wow fadeInUp'>
                    ...
                    <p className='mb-0'>
                        Integer non efficitur ex lorem ipsum. Praesent mauris, dignissim ultricies sapien non, pulvinar volutpat elit donec lorem
                        impsum blandit mollis ipsum, eu fringilla.
                    </p>
                </div>
                            ...
                            <div key={i} className='contact-2-item'>
                                ...
                                <div className='contat-2-intro'>
                                    <h4 className='contact-2-title'>
                                        {elm.link.text.split(" ")[0]} <span className='font-alt'>{elm.link.text.split(" ")[1]}</span>
                                    </h4>
